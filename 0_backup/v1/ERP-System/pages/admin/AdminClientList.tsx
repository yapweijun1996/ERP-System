    ...
    return (
        <div className="flex flex-col h-full p-4 md:p-6 gap-6 pb-20 md:pb-6">
            <div className="flex justify-between items-center shrink-0">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Tenant Operations</h1>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Manage all registered clients across the platform.</p>
                </div>
            ...
            <div className="flex gap-4 shrink-0">
                 <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm flex-1">
                    <div className="text-xs font-bold text-slate-400 uppercase">Total Active</div>
