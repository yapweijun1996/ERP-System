...
-- The compact PGlite fixture may contain the pre-0089 legacy role. Keep the
-- showcase pack post-cutover even when it is layered onto that fixture.
UPDATE role
SET is_superadmin=false,
    source_template_key=CASE WHEN source_template_key IS NULL THEN 'legacy_superadmin' ELSE source_template_key END
WHERE master_fn='M1' AND is_superadmin=true;

INSERT INTO role (master_fn, company_fn, name, is_superadmin, source_template_key)
SELECT 'M1', company_fn, 'Company Owner', false, 'company_owner'
FROM (VALUES ('C-SG'),('C-MY')) company(company_fn)
ON CONFLICT (master_fn, company_fn, name)
DO UPDATE SET is_superadmin=false, source_template_key='company_owner';
...
VALUES ('M1','admin','admin@acme.co','Avery Tan · Company Owner','pbkdf2$100000$e154d2b848d8c3d5d3d5f494b7fd446c$a299c39883dd29e1d800946af0be615e603f907ba0f4156ebdd2b287ccd4fc48','zh'),
...
JOIN (VALUES ('Master Admin','dashboard.read'),
  ...
  ('Company Owner','inventory.transfer'),
  ('Company Owner','inventory.track'),
  ('Company Owner','warehouse.read'),
  ('Company Owner','sales.read'),
  ('Company Owner','sales.write'),
  ('Company Owner','finance.read'),
  ('Company Owner','finance.write'),
  ('Company Owner','finance.budget.manage'),
  ('Company Owner','finance.report.export'),
  ('Company Owner','purchasing.read'),
  ('Company Owner','purchasing.write'),
  ('Company Owner','crm.read'),
  ('Company Owner','crm.write'),
  ('Company Owner','manufacturing.read'),
  ('Company Owner','manufacturing.write'),
  ('Company Owner','quality.read'),
  ('Company Owner','quality.write'),
  ('Company Owner','asset.read'),
  ('Company Owner','asset.write'),
  ('Company Owner','hr.read'),
  ('Company Owner','hr.write'),
  ('Company Owner','employee.self.read'),
  ('Company Owner','employee.leave.write'),
  ('Company Owner','employee.receipts.write'),
  ('Company Owner','expenses.company_receipts.read_company'),
  ('Company Owner','expenses.company_receipts.create'),
  ('Company Owner','expenses.company_receipts.edit'),
  ('Company Owner','expenses.company_receipts.void'),
  ('Company Owner','employee.claims.write'),
  ('Company Owner','documents.governance.manage'),
  ('Company Owner','documents.knowledge.read'),
  ('Company Owner','documents.records.manage'),
  ('Company Owner','documents.finance.review'),
  ('Company Owner','expenses.policy.manage'),
  ('Company Owner','expenses.duplicate.override'),
  ('Company Owner','expenses.card.manage'),
  ('Company Owner','expenses.allowance.manage'),
  ('Company Owner','expenses.advance.manage'),
  ('Company Owner','expenses.payment.prepare'),
  ('Company Owner','expenses.payment.template.manage'),
  ('Company Owner','expenses.payment.export'),
  ('Company Owner','expenses.payment.artifact.download'),
  ('Company Owner','expenses.tax_evidence.generate'),
  ('Company Owner','employee.team.read'),
  ('Company Owner','project.read'),
  ('Company Owner','project.write'),
  ('Company Owner','service.read'),
  ('Company Owner','service.write'),
  ('Company Owner','reporting.read'),
  ('Company Owner','integration.read'),
  ('Company Owner','integration.import'),
  ('Company Owner','integration.manage'),
  ('Company Owner','notifications.read'),
  ('Company Owner','notifications.manage'),
  ('Company Owner','session.switch_company'),
  ('Company Owner','admin.audit.read'),
  ('Company Owner','admin.users.invite'),
  ('Company Owner','admin.users.read'),
  ('Company Owner','admin.users.manage'),
  ('Company Owner','admin.roles.read'),
  ('Company Owner','admin.roles.write'),
  ('Company Owner','admin.master.read'),
  ('Company Owner','settings.read'),
  ('Company Owner','settings.manage'),
  ('Company Owner','sales.create'),
  ('Company Owner','sales.edit'),
  ('Company Owner','sales.post'),
  ('Company Owner','sales.export'),
  ('Company Owner','purchasing.create'),
  ('Company Owner','purchasing.edit'),
  ('Company Owner','purchasing.post'),
  ('Company Owner','purchasing.export'),
  ('Company Owner','crm.create'),
  ('Company Owner','crm.edit'),
  ('Company Owner','crm.post'),
  ('Company Owner','crm.export'),
  ('Company Owner','inventory.create'),
  ('Company Owner','inventory.edit'),
  ('Company Owner','inventory.post'),
  ('Company Owner','inventory.export'),
  ('Company Owner','warehouse.create'),
  ('Company Owner','warehouse.edit'),
  ('Company Owner','warehouse.post'),
  ('Company Owner','warehouse.export'),
  ('Company Owner','manufacturing.create'),
  ('Company Owner','manufacturing.edit'),
  ('Company Owner','manufacturing.post'),
  ('Company Owner','manufacturing.export'),
  ('Company Owner','quality.create'),
  ('Company Owner','quality.edit'),
  ('Company Owner','quality.post'),
  ('Company Owner','quality.export'),
  ('Company Owner','finance.create'),
  ('Company Owner','finance.edit'),
  ('Company Owner','finance.post'),
  ('Company Owner','finance.export'),
  ('Company Owner','hr.create'),
  ('Company Owner','hr.edit'),
  ('Company Owner','hr.post'),
  ('Company Owner','hr.export'),
  ('Company Owner','project.create'),
  ('Company Owner','project.edit'),
  ('Company Owner','project.post'),
  ('Company Owner','project.export'),
  ('Company Owner','service.create'),
  ('Company Owner','service.edit'),
  ('Company Owner','service.post'),
  ('Company Owner','service.export'),
  ('Company Owner','asset.create'),
  ('Company Owner','asset.edit'),
  ('Company Owner','asset.post'),
  ('Company Owner','asset.export'),
  ('Employee','employee.self.read'),
  ('Employee','employee.leave.write'),
  ('Employee','employee.receipts.write'),
  ('Employee','expenses.company_receipts.read_own'),
  ('Employee','expenses.company_receipts.create'),
  ('Employee','expenses.company_receipts.edit'),
  ('Employee','expenses.company_receipts.void'),
  ('Employee','employee.claims.write'),
  ('Employee','employee.payout.manage'),
  ('Company Admin','dashboard.read'),
  ...
  ('Company Admin','session.switch_company'),
  ('Company Admin','hr.read'),
  ('Company Admin','hr.write'),
  ('Company Admin','documents.knowledge.read'),
  ...
  ('Manager','expenses.company_receipts.read_own'),
  ('Manager','documents.knowledge.read'),
  ('Manager','expenses.company_receipts.create'),
  ('Manager','expenses.company_receipts.edit'),
  ('Manager','expenses.company_receipts.void'),
  ...
  ('Finance Preparer','finance.report.export'),
  ...
  ('Finance Preparer','expenses.company_receipts.read_company'),
  ...
  ('Finance Checker','expenses.tax_evidence.access'),
  ('Finance Checker','finance.budget.approve'),
  ('Finance Checker','expenses.company_receipts.read_company'),
  ('HR','dashboard.read'),
  ('HR','hr.read'),
  ('HR','hr.write'),
  ('HR','hr.create'),
...
FROM (VALUES ('admin','C-SG','Company Owner'),
...
FROM (VALUES ('C-SG','DEMO-SG-E001','Chen Wei','company-admin@acme.co','Administration','Company Administrator'),
...
FROM app_user,
  (VALUES ('C-SG','DEMO-SG-E001','company-admin@acme.co'),
  ('C-SG','DEMO-SG-E002','manager@acme.co'),
  ('C-SG','DEMO-SG-E003','sales@acme.co'),
  ('C-SG','DEMO-SG-E004','buyer@acme.co'),
  ('C-SG','DEMO-SG-E005','warehouse@acme.co'),
  ('C-SG','DEMO-SG-E006','production@acme.co'),
  ('C-SG','DEMO-SG-E007','finance-preparer@acme.co'),
  ('C-SG','DEMO-SG-E008','finance-checker@acme.co'),
  ('C-SG','DEMO-SG-E009','hr@acme.co'),
  ('C-SG','DEMO-SG-E010','service@acme.co'),
  ('C-SG','DEMO-SG-E011','admin@acme.co'),
  ('C-SG','DEMO-SG-E012','viewer@acme.co'),
  ('C-MY','DEMO-MY-E001','finance-preparer@acme.co'),
  ('C-MY','DEMO-MY-E002','finance-checker@acme.co'),
  ('C-MY','DEMO-MY-E003','hr@acme.co')) persona(company_fn,employee_no,email)
WHERE employee.master_fn='M1'
  AND employee.company_fn=persona.company_fn
  AND employee.employee_no<>persona.employee_no
