...
function integrationEventCopy(){
  const packs={
    ...
    ms:{
  "title": "Log penghantaran",
  "sub": "Fakta peti keluar transaksi yang dinyahpeka. Muatan, token dan identiti worker tidak pernah didedahkan.",
  "total": "Peristiwa",
  "delivered": "Dihantar",
  "waiting": "Menunggu penghantaran",
  "retry": "Perlu cuba semula",
  "all": "Semua",
  "processing": "Sedang diproses",
  "pending": "Menunggu",
  "channel": "Saluran",
  "topic": "Topik peristiwa",
  "aggregate": "Rekod sumber",
  "attempts": "Percubaan",
  "activity": "Aktiviti terakhir",
  "status": "Status",
  "details": "Butiran penghantaran",
  "email": "E-mel",
  "outbox": "Peti keluar",
  "outbound": "Keluar",
  "none": "Belum ada fakta penghantaran untuk syarikat ini.",
  "emptyFilter": "Tiada peristiwa sepadan dengan status ini.",
  "loading": "Memuatkan fakta penghantaran kanonik…",
  "error": "Fakta penghantaran tidak dapat dimuatkan.",
  "retryLoad": "Cuba lagi",
  "connectorPreview": "Pratonton penyambung",
  "bounded": "100 peristiwa terkini · paling baharu dahulu",
  "readOnly": "Sempadan baca sahaja",
  "readOnlyBody": "Cubaan semula penghantaran dikawal oleh worker pelayan bersewa. Persediaan penyambung dan ulang tayang manual kekal Pratonton sehingga kelayakan disulitkan dan penghantaran webhook generik tersedia.",
  "errorNone": "Tiada ralat worker direkodkan.",
  "errorTransport": "Pengangkutan penghantaran tidak tersedia. Worker akan mencuba semula dengan sela meningkat.",
  "errorUnsupported": "Worker belum menyokong topik ini.",
  "errorGeneric": "Penghantaran gagal. Diagnostik worker sensitif disembunyikan.",
  "available": "Tersedia seterusnya",
  "created": "Dicipta"
},
    zh:{
  "title": "投递日志",
  "sub": "来自事务 Outbox 的脱敏事实。载荷、令牌和 Worker 身份绝不会在此暴露。",
  "total": "事件",
  "delivered": "已投递",
  "waiting": "等待投递",
  "retry": "需要重试",
  ...
  "outbound": "出站",
  "none": "当前公司尚无投递事实。",
  "emptyFilter": "没有符合该状态的事件。",
  "loading": "正在加载真实投递事实…",
  "error": "无法加载投递事实。",
  "retryLoad": "重试",
  "connectorPreview": "连接器预览",
  "bounded": "最近 100 个事件 · 最新优先",
  "readOnly": "只读边界",
  "readOnlyBody": "投递重试只由采用租约的服务端 Worker 控制。在加密凭据和通用 Webhook 投递完成前，连接器设置与手工重放仍为预览功能。",
  "errorNone": "未记录 Worker 错误。",
  "errorTransport": "投递渠道不可用。Worker 将按退避策略重试。",
  "errorUnsupported": "Worker 尚不支持该事件主题。",
  "errorGeneric": "投递失败。敏感的 Worker 诊断资料已隐藏。",
  "available": "下次可用",
  "created": "创建时间"
},
    ja:{
  "title": "配信ログ",
  "sub": "トランザクションOutboxのマスキング済み事実です。ペイロード、トークン、ワーカーIDは公開しません。",
  "total": "イベント",
  "delivered": "配信済み",
  "waiting": "配信待ち",
  "retry": "再試行が必要",
  ...
  "outbox": "送信ボックス",
  "outbound": "送信",
  "none": "この会社には配信事実がありません。",
  "emptyFilter": "このステータスに一致するイベントはありません。",
  "loading": "標準配信事実を読み込み中…",
  "error": "配信事実を読み込めません。",
  "retryLoad": "再試行",
  "connectorPreview": "コネクタープレビュー",
  "bounded": "最新100イベント・新しい順",
  "readOnly": "読み取り専用境界",
  "readOnlyBody": "再試行はリース方式のサーバーワーカーだけが制御します。暗号化認証情報と汎用Webhook配信が完成するまで、コネクター設定と手動再実行はプレビューのままです。",
  "errorNone": "ワーカーエラーは記録されていません。",
  "errorTransport": "配信トランスポートを利用できません。ワーカーがバックオフして再試行します。",
  "errorUnsupported": "ワーカーはこのトピックをまだサポートしていません。",
  "errorGeneric": "配信に失敗しました。機密性のある診断情報は非表示です。",
  "available": "次回実行可能",
  "created": "作成日時"
},
    vi:{
  "title": "Nhật ký chuyển phát",
  "sub": "Dữ kiện transactional outbox đã được che dữ liệu nhạy cảm. Payload, token và danh tính worker không bao giờ được hiển thị.",
  "total": "Sự kiện",
  "delivered": "Đã chuyển",
  "waiting": "Đang chờ chuyển",
  "retry": "Cần thử lại",
  "all": "Tất cả",
  ...
  "aggregate": "Bản ghi nguồn",
  "attempts": "Số lần thử",
  "activity": "Hoạt động gần nhất",
  "status": "Trạng thái",
  "details": "Chi tiết chuyển phát",
  "email": "E-mail",
  "outbox": "Hộp thư đi",
  "outbound": "Gửi đi",
  "none": "Chưa có dữ kiện chuyển phát cho công ty này.",
  "emptyFilter": "Không có sự kiện phù hợp trạng thái này.",
  "loading": "Đang tải dữ kiện chuyển phát chuẩn…",
  "error": "Không thể tải dữ kiện chuyển phát.",
  "retryLoad": "Thử lại",
  "connectorPreview": "Xem trước trình kết nối",
  "bounded": "100 sự kiện mới nhất · mới nhất trước",
  "readOnly": "Ranh giới chỉ đọc",
  "readOnlyBody": "Việc thử lại do worker máy chủ có lease kiểm soát. Cấu hình trình kết nối và phát lại thủ công vẫn là Bản xem trước cho đến khi có thông tin xác thực mã hóa và webhook chung.",
  "errorNone": "Không ghi nhận lỗi worker.",
  "errorTransport": "Kênh chuyển phát không khả dụng. Worker sẽ thử lại với thời gian lùi.",
  "errorUnsupported": "Worker chưa hỗ trợ chủ đề này.",
  "errorGeneric": "Chuyển phát thất bại. Chẩn đoán nhạy cảm của worker đã được ẩn.",
  "available": "Lần khả dụng kế tiếp",
  "created": "Đã tạo"
},
  };
