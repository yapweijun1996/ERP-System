...
function accountLedgerCopy(){
  const packs={
    ...
    ms:{
  "title": "Lejar akaun",
  "posted": "Lejar kanonik telah dipos",
  "entries": "catatan",
  "firstRows": "100 baris pertama",
  "opening": "Baki awal",
  "debits": "Jumlah debit",
  "credits": "Jumlah kredit",
  "closing": "Baki akhir",
  "transactions": "Transaksi",
  "running": "Baki berjalan",
  "date": "Tarikh",
  "reference": "Rujukan",
  "debit": "Debit",
  "credit": "Kredit",
  "balance": "Baki",
  "back": "Kembali ke Lejar Am",
  "empty": "Tiada catatan dipos",
  "emptyHelp": "Akaun ini belum mempunyai catatan jurnal kanonik.",
  "unavailable": "Lejar akaun tidak tersedia",
  "unavailableHelp": "Kembali ke Lejar Am dan pilih akaun yang tersedia.",
  "loadError": "Lejar akaun tidak dapat dimuatkan.",
  "retry": "Cuba lagi"
},
    zh:{
...
function bankReconciliationCopy(){
  ...
  "sub": "Import fakta penyata bank, padankan kaki GL bank tepat dan kunci penyata lengkap.",
  "import": "Import penyata",
  "statements": "Penyata",
  "select": "Pilih penyata",
  "period": "Tempoh",
  "account": "Akaun bank",
  "status": "Status",
  "draft": "Draf",
  ...
  "date": "Tarikh",
  "amount": "Amaun",
  "ledger": "Padanan Lejar Am",
  "noCandidate": "Tiada kaki GL bank belum dipadan dengan amaun tepat.",
  "postFirst": "Pos aktiviti bank yang hilang dahulu",
  "complete": "Lengkapkan penyesuaian",
  "completeTitle": "Lengkapkan penyesuaian ini?",
  "completeBody": "Setiap baris penyata telah dipadankan. Penyempurnaan akan mengunci penyata dan padanannya.",
  "confirm": "Lengkap & kunci",
  "cancel": "Batal",
  "done": "Penyata bank telah disesuaikan",
  "matchedMsg": "Baris penyata dipadankan",
  "unmatchedMsg": "Padanan baris dibatalkan",
  "empty": "Belum ada penyata bank",
  "emptyHelp": "Import penyata sebenar untuk bermula. Tiada penyata sampel diganti.",
  "number": "Nombor penyata",
  "start": "Mula tempoh",
  "end": "Akhir tempoh",
  "opening": "Baki awal",
  "closing": "Baki akhir",
  "csv": "Baris CSV penyata",
  "csvHint": "Satu baris: tarikh, rujukan, keterangan, amaun bertanda. Positif masuk; negatif keluar.",
  "csvExample": "2026-07-22,REF-001,Terimaan pelanggan,125.00",
  "importing": "Mengimport…",
  "importNow": "Sahkan & import",
  "required": "Lengkapkan pengepala dan sertakan sekurang-kurangnya satu baris CSV.",
  "invalidCsv": "Setiap baris CSV memerlukan tarikh sah, keterangan dan amaun bukan sifar.",
  "imported": "Penyata bank diimport",
  "source": "Sumber kanonik",
  "sourceHelp": "Baris penyata diimport dan kaki GL tidak berubah; padanan tidak mencipta catatan.",
  "matchedCount": "{m} daripada {n} baris dipadan",
  "movement": "Pergerakan penyata",
  "balance": "Baki akhir",
  "candidate": "Pilih catatan GL…",
  "noAccounts": "Tiada akaun aset dikonfigurasi untuk syarikat ini.",
  "retry": "Cuba lagi",
  "error": "Penyesuaian bank tidak dapat dimuatkan.",
  "allMatched": "Semua baris penyata telah dipadankan.",
  "stillOpen": "Padankan setiap baris sebelum lengkap.",
  "immutable": "Penyata lengkap tidak boleh diubah.",
  "exact": "Amaun dan akaun bank tepat dikuatkuasakan oleh arahan domain."
},
