...
function projectCopy(){
  ...
  const packs={
    ...
    ms:{
  "colBilled": "Dibil setakat ini",
  "overBilledAlert": "{n} projek telah membilkan lebih daripada nilai kontrak.",
  "fieldProjectNo": "No. projek",
  "systemNumbered": "Bernombor sistem",
  "fieldName": "Nama projek",
  "namePlaceholder": "cth. Beta Pte Ltd — Integrasi Sel",
  "fieldCustomer": "Pelanggan",
  "internalOption": "Projek dalaman (tiada pelanggan)",
  "fieldManager": "Pengurus projek",
  "managerPlaceholder": "cth. Liam Cardoso",
  "fieldStatus": "Status",
  "fieldStartDate": "Tarikh mula",
  "fieldDueDate": "Tarikh akhir",
  "optional": "pilihan",
  "fieldContractValue": "Nilai kontrak",
  "nameRequired": "Nama projek diperlukan",
  "managerRequired": "Pengurus projek diperlukan",
  "projectCreated": "Projek {no} didaftarkan",
  "projectSaveError": "Projek tidak dapat didaftarkan",
  "createProject": "Daftar projek",
  "internalNote": "Projek dalaman tiada pelanggan dan tidak boleh menerima tuntutan kemajuan.",
  "completedNote": "Projek ini telah selesai dan tidak boleh menerima tuntutan kemajuan baharu.",
  "claimsPanel": "Tuntutan Kemajuan",
  "claimsEmpty": "Belum ada tuntutan kemajuan.",
  "colClaimNo": "Tuntutan",
  "colClaimDate": "Tarikh",
  ...
  "colTax": "Cukai",
  "colTotal": "Jumlah",
  "newClaim": "Tuntutan kemajuan baharu",
  "fieldClaimNo": "No. tuntutan",
  "fieldClaimDate": "Tarikh tuntutan",
  "fieldDescriptionField": "Keterangan",
  "descriptionPlaceholder": "cth. Fabrikasi 50% siap",
  "fieldNetAmount": "Jumlah bersih",
  "descriptionRequired": "Keterangan diperlukan",
  "claimCreated": "Tuntutan kemajuan {no} dicipta",
  "claimSaveError": "Tuntutan kemajuan tidak dapat dicipta",
  "postClaim": "Catat",
  "claimPosted": "Tuntutan kemajuan {no} dicatat — {amount} ke GL",
  "claimPostError": "Tuntutan kemajuan tidak dapat dicatat",
  "billingSummary": "Ringkasan bilan",
  "contractValue": "Nilai kontrak",
  "headroom": "Ruang baki",
  "overBilledIndicator": "Lebih bil",
  "onTrackIndicator": "Dalam kontrak",
  "activityProjectCreated": "Projek didaftarkan",
  "activityClaimCreated": "Tuntutan kemajuan {no} didraf — {amount}",
  "activityClaimPosted": "Tuntutan kemajuan {no} dicatat — {amount} ke GL",
  "internalProject": "Projek dalaman",
  "linkedCustomer": "Pelanggan berkaitan",
  "customer360": "Pelanggan 360"
    ...
    vi:{
  "colBilled": "Đã xuất hóa đơn lũy kế",
  "overBilledAlert": "{n} dự án đã xuất hóa đơn vượt giá trị hợp đồng.",
  "fieldProjectNo": "Mã dự án",
  "systemNumbered": "Đánh số tự động",
  "fieldName": "Tên dự án",
  "namePlaceholder": "vd: Beta Pte Ltd — Tích hợp cụm",
  "fieldCustomer": "Khách hàng",
  "internalOption": "Dự án nội bộ (không có khách hàng)",
  "fieldManager": "Quản lý dự án",
  "managerPlaceholder": "vd: Liam Cardoso",
  "fieldStatus": "Trạng thái",
  "fieldStartDate": "Ngày bắt đầu",
  "fieldDueDate": "Ngày kết thúc",
  "optional": "tùy chọn",
  "fieldContractValue": "Giá trị hợp đồng",
  "nameRequired": "Vui lòng nhập tên dự án",
  "managerRequired": "Vui lòng nhập quản lý dự án",
  "projectCreated": "Đã đăng ký dự án {no}",
  "projectSaveError": "Không thể đăng ký dự án",
  "createProject": "Đăng ký dự án",
  "internalNote": "Dự án nội bộ không có khách hàng nên không thể lập đợt xuất hóa đơn tiến độ.",
  "completedNote": "Dự án này đã hoàn thành và không thể lập đợt xuất hóa đơn tiến độ mới.",
  "claimsPanel": "Hóa Đơn Tiến Độ",
  "claimsEmpty": "Chưa có hóa đơn tiến độ nào.",
  "colClaimNo": "Số hóa đơn",
  "colClaimDate": "Ngày",
  "colDescription": "Mô tả",
  "colNet": "Tiền chưa thuế",
  "colTax": "Thuế",
  "colTotal": "Tổng cộng",
  "newClaim": "Hóa đơn tiến độ mới",
  "fieldClaimNo": "Số hóa đơn",
  "fieldClaimDate": "Ngày hóa đơn",
  "fieldDescriptionField": "Mô tả",
  "descriptionPlaceholder": "vd: Chế tạo hoàn thành 50%",
  "fieldNetAmount": "Tiền chưa thuế",
  "descriptionRequired": "Vui lòng nhập mô tả",
  "claimCreated": "Đã tạo hóa đơn tiến độ {no}",
  "claimSaveError": "Không thể tạo hóa đơn tiến độ",
  "postClaim": "Ghi sổ",
  "claimPosted": "Đã ghi sổ hóa đơn tiến độ {no} — {amount} vào sổ cái",
  "claimPostError": "Không thể ghi sổ hóa đơn tiến độ",
  "billingSummary": "Tóm tắt hóa đơn",
  "contractValue": "Giá trị hợp đồng",
  "headroom": "Hạn mức còn lại",
  "overBilledIndicator": "Vượt hóa đơn",
  "onTrackIndicator": "Trong hạn mức hợp đồng",
  "activityProjectCreated": "Đã đăng ký dự án",
  "activityClaimCreated": "Hóa đơn tiến độ {no} đã lập nháp — {amount}",
  "activityClaimPosted": "Hóa đơn tiến độ {no} đã ghi sổ — {amount} vào sổ cái",
  "internalProject": "Dự án nội bộ",
...
function timesheetCopy(){
  ...
  const packs={
    ...
    ms:{
  "title": "Lembaran masa",
  "sub": "Fakta masa projek anda yang diaudit untuk {week}. Entri dibatalkan kekal kelihatan.",
  "previous": "Minggu sebelumnya",
  "next": "Minggu seterusnya",
  "current": "Minggu semasa",
  "add": "Log masa",
  "total": "Jam aktif",
  "projects": "Projek",
  "days": "Hari bekerja",
  ...
  "active": "Aktif",
  "voided": "Dibatalkan",
  "empty": "Tiada masa direkod untuk minggu ini",
  "emptyBody": "Log masa kepada projek terbuka. Kelulusan dan gaji ialah aliran berasingan dan tidak direka di sini.",
  "loading": "Memuatkan lembaran masa…",
  "loadError": "Lembaran masa tidak dapat dimuatkan",
  "retry": "Cuba lagi",
  "formTitle": "Log masa projek",
  "selectProject": "Pilih projek terbuka",
  "workDate": "Tarikh kerja",
  "taskPlaceholder": "cth. Semakan pentauliahan",
  "hoursHint": "0.01–24.00 jam",
  "projectRequired": "Pilih projek.",
  "dateRequired": "Pilih tarikh kerja.",
  "taskRequired": "Masukkan tugas.",
  "hoursRequired": "Masukkan jam melebihi 0 dan tidak melebihi 24.",
  "created": "Entri masa disimpan.",
  "createError": "Entri masa tidak dapat disimpan.",
  "noOpen": "Tiada projek terbuka untuk entri masa.",
  "void": "Batal",
  "voidTitle": "Batalkan entri masa",
  "voidBody": "Jam asal kekal dalam sejarah audit dan tidak lagi dikira.",
  "reason": "Sebab",
  "reasonPlaceholder": "cth. Dilog kepada pakej kerja yang salah",
  "reasonRequired": "Masukkan sebab pembatalan.",
  "confirmVoid": "Batalkan entri",
  "voidedToast": "Entri masa dibatalkan.",
  "voidError": "Entri masa tidak dapat dibatalkan.",
  "owner": "Pengguna log masuk",
  "bounded": "Paparan mingguan ini dihadkan kepada 100 entri."
},
    zh:{
