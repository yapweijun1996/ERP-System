...
SCREENS['new-employee'] = async function(root){
  ...
  function render(){
    root.innerHTML=`<div class="content full"><section class="master"><div class="docwrap"><div class="docpage">
      ...
      <div class="doclayout staff-onboarding-layout"><div class="docmain">
        ...
        <div class="panel" ${step===1?'':'hidden'}><div class="panel-h">${ic('user')}<h3>${esc(t('staff.step.profile'))}</h3></div><div class="panel-body">
          ...
          <div class="fld"><span>${esc(t('staff.employeeNo'))}</span><input id="neNumber" value="" placeholder="${esc(s('autoGenerated'))}" readonly aria-readonly="true"><small class="hint">${esc(s('systemNumbered'))}</small></div></div>
  ...
  async function activate(){
    ...
    try{
      const created=await window.ErpSystemData.createStaffAccount({
        employee:{employeeNo:draft.neNumber,employeeNoMode:'auto',fullName:draft.neName,email:draft.neEmail,
