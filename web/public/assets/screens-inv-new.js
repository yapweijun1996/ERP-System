...
function newItemCopy(){
  ...
  const packs={
    ...
    ms:{
      title:'Item baharu',sub:'Cipta data induk inventori untuk syarikat aktif.',draft:'Draf',master:'Induk produk',
      basic:'Maklumat asas',sku:'SKU',skuPlaceholder:'cth. SG-HOSE-12',skuHelp:'Kod item syarikat yang unik. Ia tidak boleh diubah selepas dicipta.',
      name:'Nama item',namePlaceholder:'cth. Hos Hidraulik 12mm',category:'Kategori',uom:'UoM asas',
      settings:'Perancangan inventori',standardCost:'Kos standard',costHelp:'Digunakan sebagai nilai sandaran sehingga penerimaan bernilai menetapkan kos purata.',
      reorderPoint:'Titik pesan semula',reorderQty:'Kuantiti pesan semula',zeroTitle:'Bermula dengan stok sifar',
      ...
      next:'Langkah seterusnya selepas dicipta',nextBody:'Buka Pelarasan Stok apabila anda perlu menetapkan kiraan fizikal awal.',
      cancel:'Batal',create:'Cipta item',saving:'Mencipta…',ready:'Sedia mencipta data induk produk',
      incomplete:'Masukkan SKU dan nama item yang diperlukan',skuRequired:'SKU diperlukan.',nameRequired:'Nama item diperlukan.',
      invalidNumber:'Kos dan nilai pesanan semula mestilah nombor bukan negatif.',created:'Item {sku} dicipta dengan stok sifar.',
      failed:'Item tidak dapat dicipta.',catComponents:'Komponen',catRaw:'Bahan Mentah',catFinished:'Barang Siap',catConsumables:'Barang Guna Habis',catPackaging:'Pembungkusan',
    },
    zh:{
      title:'新增物料',sub:'为当前公司创建真实的库存主数据。',draft:'草稿',master:'商品主数据',
      basic:'基本信息',sku:'SKU',skuPlaceholder:'例如 SG-HOSE-12',skuHelp:'当前公司的唯一物料编码，创建后不可更改。',
      name:'物料名称',namePlaceholder:'例如：液压软管 12mm',category:'类别',uom:'基本计量单位',
      settings:'库存计划',standardCost:'标准成本',costHelp:'在有计价收货建立移动平均成本之前，作为估值的后备成本。',
      reorderPoint:'再订货点',reorderQty:'再订货量',zeroTitle:'初始库存为零',
      zeroBody:'创建主数据不会写入期初余额。请通过采购收货或库存调整接收库存，确保每个数量都有库存流水。',
      next:'创建后的下一步',nextBody:'需要建立首次实盘数量时，请打开“库存调整”。',
      cancel:'取消',create:'创建物料',saving:'正在创建…',ready:'可以创建商品主数据',
      incomplete:'请输入必填的 SKU 和物料名称',skuRequired:'请输入 SKU。',nameRequired:'请输入物料名称。',
      invalidNumber:'成本和再订货数值必须是非负数。',created:'物料 {sku} 已创建，当前库存为零。',
      failed:'物料创建失败。',catComponents:'零部件',catRaw:'原材料',catFinished:'成品',catConsumables:'耗材',catPackaging:'包装',
    },
    ja:{
      title:'新規品目',sub:'現在の会社の在庫マスタデータを作成します。',draft:'下書き',master:'品目マスタ',
      basic:'基本情報',sku:'SKU',skuPlaceholder:'例 SG-HOSE-12',skuHelp:'会社内で一意の品目コードです。作成後は変更できません。',
      name:'品目名',namePlaceholder:'例：油圧ホース 12mm',category:'カテゴリ',uom:'基本単位',
      settings:'在庫計画',standardCost:'標準原価',costHelp:'評価済み入庫で平均原価が確立するまで、評価の代替原価として使用されます。',
      reorderPoint:'発注点',reorderQty:'発注数量',zeroTitle:'在庫ゼロで開始',
      zeroBody:'マスタ作成では期首在庫を記録しません。すべての数量に入出庫履歴を残すため、購買入庫または在庫調整で受け入れてください。',
      next:'作成後の次の手順',nextBody:'初回の実地棚卸数量を設定する場合は、在庫調整を開いてください。',
      cancel:'キャンセル',create:'品目を作成',saving:'作成中…',ready:'品目マスタを作成できます',
      incomplete:'必須の SKU と品目名を入力してください',skuRequired:'SKU を入力してください。',nameRequired:'品目名を入力してください。',
      invalidNumber:'原価と発注値は 0 以上の数値でなければなりません。',created:'品目 {sku} を在庫ゼロで作成しました。',
      failed:'品目を作成できませんでした。',catComponents:'部品',catRaw:'原材料',catFinished:'完成品',catConsumables:'消耗品',catPackaging:'梱包資材',
    },
    vi:{
      title:'Mặt hàng mới',sub:'Tạo dữ liệu gốc tồn kho cho công ty đang hoạt động.',draft:'Bản nháp',master:'Dữ liệu gốc sản phẩm',
      basic:'Thông tin cơ bản',sku:'SKU',skuPlaceholder:'vd. SG-HOSE-12',skuHelp:'Mã mặt hàng duy nhất trong công ty. Không thể đổi sau khi tạo.',
      name:'Tên mặt hàng',namePlaceholder:'vd. Ống thủy lực 12mm',category:'Danh mục',uom:'ĐVT cơ bản',
      settings:'Kế hoạch tồn kho',standardCost:'Chi phí tiêu chuẩn',costHelp:'Dùng làm giá dự phòng cho đến khi phiếu nhập có giá thiết lập chi phí bình quân.',
      reorderPoint:'Điểm đặt hàng lại',reorderQty:'SL đặt hàng lại',zeroTitle:'Bắt đầu với tồn kho bằng không',
      ...
      next:'Bước tiếp theo sau khi tạo',nextBody:'Mở Điều chỉnh tồn kho khi cần thiết lập số lượng kiểm kê ban đầu.',
      cancel:'Hủy',create:'Tạo mặt hàng',saving:'Đang tạo…',ready:'Sẵn sàng tạo dữ liệu gốc sản phẩm',
      incomplete:'Nhập SKU và tên mặt hàng bắt buộc',skuRequired:'Cần nhập SKU.',nameRequired:'Cần nhập tên mặt hàng.',
      invalidNumber:'Chi phí và giá trị đặt lại phải là số không âm.',created:'Đã tạo mặt hàng {sku} với tồn kho bằng không.',
      failed:'Không thể tạo mặt hàng.',catComponents:'Linh kiện',catRaw:'Nguyên liệu',catFinished:'Thành phẩm',catConsumables:'Vật tư tiêu hao',catPackaging:'Bao bì',
    },
  };
