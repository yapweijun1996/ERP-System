...
function serviceCopy(){
  ...
  const packs={
    ...
    ms:{
  "contractExpiring": "Akan tamat",
  "contractExpired": "Tamat tempoh",
  "serviceOrderTitle": "Pesanan Servis",
  "serviceOrderDescription": "Semak isu, konteks servis dan kitaran hayat tiket yang dipilih.",
  "serviceContext": "Konteks servis",
  "lifecycleLabel": "Kitaran hayat tiket",
  "fieldOpened": "Dibuka",
  "fieldResolved": "Diselesaikan",
  "noServiceOrder": "Pesanan servis tidak ditemui",
  "noServiceOrderBody": "Tiada tiket servis tersedia untuk syarikat semasa.",
  "kpiOverdue": "Tertunggak",
  "overdueAlert": "{n} tiket telah melepasi tempoh respons SLA.",
  "fieldTicketNo": "No. tiket",
  "systemNumbered": "Bernombor sistem",
  "fieldCustomer": "Pelanggan",
  "fieldAssetDescription": "Aset",
  "assetPlaceholder": "cth. Unit Pemacu Konveyor",
  "fieldSerialNo": "No. siri (pilihan)",
  "fieldIssue": "Isu",
  "issuePlaceholder": "cth. Unit pemacu terlalu panas, terhenti sekejap-sekejap",
  "fieldPriority": "Keutamaan",
  "fieldCoverage": "Liputan",
  "fieldContract": "Kontrak (pilihan)",
  "noContract": "Tiada kontrak",
  "nameRequired": "Aset diperlukan",
  "issueRequired": "Isu diperlukan",
  "customerRequired": "Pelanggan diperlukan",
  "ticketCreated": "Tiket {no} dicatat",
  "ticketSaveError": "Tiket tidak dapat dicatat",
  "createTicket": "Catat tiket",
  "unassigned": "Belum ditugaskan",
  "technician": "Juruteknik",
  "fieldTechnician": "Nama juruteknik",
  "technicianPlaceholder": "cth. Kwame Mensah",
  "technicianRequired": "Nama juruteknik diperlukan",
  "assign": "Tugaskan",
  "assignTitle": "Tugaskan juruteknik",
  "ticketAssigned": "{no} ditugaskan kepada {tech}",
  "ticketAssignError": "Tiket tidak dapat ditugaskan",
  "resolveClose": "Selesai & tutup",
  "resolveTitle": "Selesaikan & tutup tiket",
  "fieldDiagnosis": "Diagnosis",
  "diagnosisPlaceholder": "cth. Set galas haus digantikan; diuji melalui 3 kitaran, berfungsi normal.",
  "diagnosisRequired": "Diagnosis diperlukan",
  "ticketResolved": "{no} diselesaikan dan ditutup",
  "ticketResolveError": "Tiket tidak dapat diselesaikan",
  "slaTitle": "SLA",
  "responseDue": "Respons perlu",
  "overdueBy": "Tertunggak selama {t}",
  "timeLeft": "{t} berbaki",
  "noSla": "Tiada SLA pada tiket ini",
  "noSlaSub": "Tiket ini tiada kontrak berkaitan dengan komitmen masa respons.",
  "openedOn": "dibuka {d}",
  "dueOn": "perlu {d}",
  "coverageLabel": "Liputan",
  "billable": "Boleh dibil",
  "billableYes": "Ya",
  "billableNo": "Tidak — dalam waranti",
  "customer360": "Pelanggan 360",
  "contractsPanel": "Kontrak berkaitan",
  "noContractLinked": "Tiada kontrak dikaitkan dengan tiket ini.",
  "diagnosisPanel": "Diagnosis",
  "reportedIssue": "Isu dilaporkan",
  "technicianDiagnosis": "Diagnosis juruteknik",
  "noDiagnosisYet": "Belum ada diagnosis dicatat — selesaikan tiket untuk menambah satu.",
  "fieldContractNo": "No. kontrak",
  "fieldPlan": "Pelan",
  "fieldSlaHours": "Respons SLA (jam, pilihan)",
  "fieldAssetsCovered": "Aset dilindungi",
  "fieldStartDate": "Tarikh mula",
  "fieldExpiryDate": "Tarikh tamat",
  "fieldAnnualValue": "Nilai tahunan",
  "contractCreated": "Kontrak {no} didaftarkan",
  "contractSaveError": "Kontrak tidak dapat didaftarkan",
  "createContract": "Daftar kontrak",
  "activeContracts": "Aktif",
  "annualValueKpi": "Nilai tahunan",
  "expiringSoon": "{n} pembaharuan perlu dalam 60 hari.",
  "serviceContractTitle": "Kontrak servis",
  "serviceContractDescription": "Semak pelanggan, liputan dan fakta pembaharuan untuk kontrak yang dipilih.",
  "noServiceContract": "Kontrak servis tidak ditemui",
  "noServiceContractBody": "Pilih kontrak daripada daftar Kontrak untuk melihat butirannya.",
  "commercialTerms": "Terma komersial",
  "contractTerm": "Tempoh kontrak",
  "renewalContext": "Konteks pembaharuan",
  "renewalDue": "Pembaharuan perlu dalam {n} hari.",
  "renewalExpired": "Kontrak ini tamat {n} hari lalu.",
  "renewalHealthy": "Kontrak mempunyai baki {n} hari.",
  "days": "hari",
