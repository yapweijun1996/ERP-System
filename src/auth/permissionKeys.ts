...
export const PERMISSIONS = {
  ...
  expensesCompanyReceiptsCreate: 'expenses.company_receipts.create',
  expensesCompanyReceiptsEdit: 'expenses.company_receipts.edit',
  expensesCompanyReceiptsVoid: 'expenses.company_receipts.void',
  employeeTeamRead: 'employee.team.read',
  projectRead: 'project.read',
  projectWrite: 'project.write',
  serviceRead: 'service.read',
  serviceWrite: 'service.write',
  productCasesSubmit: 'product.cases.submit',
  productCasesReadOwn: 'product.cases.read_own',
  productCasesEvidenceAppend: 'product.cases.evidence_append',
  productCasesRead: 'product.cases.read',
  productCasesManage: 'product.cases.manage',
  productCasesRelease: 'product.cases.release',
  productCasesVerify: 'product.cases.verify',
