...
DECLARE
  ...
  company_tables text[] := ARRAY[
    ...
    'company_receipt',
    'company_receipt_pack', 'company_receipt_pack_governance_event',
    'company_receipt_pack_purge_request', 'company_receipt_pack_tombstone',
    ...
    'expense_claim_submission_authorization', 'expense_claim_revision',
    'expense_claim_event', 'expense_control_policy_version',
    'expense_line_control_assessment', 'expense_duplicate_signal',
    'expense_duplicate_override', 'expense_line_approval',
    'corporate_card_import', 'corporate_card_transaction',
    'corporate_card_match_candidate', 'corporate_card_follow_up',
    'corporate_card_event',
