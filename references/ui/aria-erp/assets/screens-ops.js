...
SCREENS['dashboard'] = function(root){
  ...
  const attention=[
    wc({tone:'danger',icon:'flow',title:t('dash.c.approvals'),num:'7',meta:t('dash.c.approvals.meta'),body:t('dash.c.approvals.body'),cta:t('dash.c.approvals.cta'),route:'po-approval'}),
    wc({tone:'danger',icon:'error',title:t('dash.c.gl'),num:'1',body:t('dash.c.gl.body'),cta:t('dash.c.gl.cta'),route:'journal-entry'}),
    wc({tone:'warn',icon:'box',title:t('dash.c.stock'),num:'4',meta:t('dash.c.stock.meta'),body:t('dash.c.stock.body'),cta:t('dash.c.stock.cta'),route:'stock-on-hand'}),
    wc({tone:'warn',icon:'receipt',title:t('dash.c.ar'),num:'$46.6k',deltaDir:'up',delta:'+$14.2k WoW',body:t('dash.c.ar.body'),cta:t('dash.c.ar.cta'),route:'dashboard'}),
  ];
  const ops=[
    wc({tone:'accent',icon:'truck',title:t('dash.c.deliver'),num:'5',body:t('dash.c.deliver.body'),cta:t('dash.c.deliver.cta'),route:'sales-orders'}),
    wc({tone:'accent',icon:'receive',title:t('dash.c.grn'),num:'3',body:t('dash.c.grn.body'),cta:t('dash.c.grn.cta'),route:'purchase-orders'}),
    wc({tone:'teal',icon:'warehouse',title:t('dash.c.pick'),num:'5',meta:t('dash.c.pick.meta'),body:t('dash.c.pick.body'),cta:t('dash.c.pick.cta'),route:'picking'}),
    wc({tone:'violet',icon:'people',title:t('dash.c.leave'),num:'4',body:t('dash.c.leave.body'),cta:t('dash.c.leave.cta'),route:'leave-approval'}),
  ];
    ...
    <div class="scrollarea">
      <div class="pagehead">
        ...
        <div class="h1row">
          ...
          <div class="headright">
            <div class="kfig"><small>${esc(t('dash.kpi.openorder'))}</small><b class="tnum">$1.24M</b></div>
            <div class="kfig"><small>${esc(t('dash.kpi.cash'))}</small><b class="tnum">$842k</b></div>
            <div class="kfig"><small>${esc(t('dash.kpi.mtd'))}</small><b class="tnum pos">$3.18M</b></div>
          </div>
        </div>
      ...
      <div class="dash">
        ...
        <div class="dashgrid">
          ...
          <div class="wcard" style="cursor:default">
            ...
            <div class="wc-num"><b class="tnum">31</b><span class="wc-delta up">${esc(t('dash.q.ontime'))}</span></div>
            <p>${t('dash.q.body')}</p>
          </div>
        </div>
      </div>
