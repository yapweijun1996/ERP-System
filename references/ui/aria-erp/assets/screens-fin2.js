...
function signed0(n){ return (n<0?'−':'')+'$'+Math.abs(Math.round(n)).toLocaleString('en-US'); }
...
SCREENS['gl'] = function(root){
  ...
  root.innerHTML=`<div class="content full"><section class="master">
    ...
    <div class="statwrap"><div class="statcards">
      ${statTile(t('gl.t.cash'),money0(cash),t('gl.t.cashsub'))}
      ${statTile(t('gl.t.ar'),money0(ar),t('gl.t.arsub'),'var(--warn)')}
      ${statTile(t('gl.t.ap'),money0(ap),t('gl.t.apsub'))}
      ${statTile(t('gl.t.net'),money0(net),t('gl.t.netsub'),'var(--ok)')}
    </div></div>
    <div class="toolbar">
