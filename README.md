...
The browser demo uses PGlite/IndexedDB with the canonical 56-table schema and working
Sales, Purchasing, CRM, inventory, warehouse-picking and manufacturing work-order
transaction chains. Route-level
`SCREEN_META` currently classifies 28 routes as Canonical and 86 as
