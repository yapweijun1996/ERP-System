...
The browser demo uses PGlite/IndexedDB with the canonical 65-table schema and working
Sales, Purchasing, CRM, inventory, warehouse-picking and manufacturing work-order
transaction chains. Route-level
`SCREEN_META` currently classifies 35 routes as Canonical and 79 as
