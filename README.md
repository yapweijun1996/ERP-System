...
The browser demo uses PGlite/IndexedDB with the canonical 67-table schema and working
Sales, Purchasing, CRM, inventory, warehouse-picking and manufacturing work-order
transaction chains. Route-level
`SCREEN_META` currently classifies 37 routes as Canonical and 77 as
