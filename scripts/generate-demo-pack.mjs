...
const personaSpecs = [
  ['admin', 'admin@acme.co', 'Avery Tan · Company Owner', 'Company Owner', 'zh'],
...
const rolePermissions = {
  ...
  Employee: [
    ...
    'expenses.company_receipts.read_own','expenses.company_receipts.create',
    'expenses.company_receipts.edit','expenses.company_receipts.void',
    'employee.claims.write','employee.payout.manage',
  ],
  'Company Admin': ['dashboard.read','admin.users.invite','admin.users.read','admin.users.manage','admin.roles.read','admin.roles.write','admin.audit.read','settings.read','settings.manage','session.switch_company','hr.read','hr.write','documents.knowledge.read'],
  Manager: [
    'dashboard.read','employee.self.read','employee.team.read','employee.leave.write',
    'employee.receipts.write','expenses.company_receipts.read_own',
    'documents.knowledge.read',
    'expenses.company_receipts.create','expenses.company_receipts.edit',
    'expenses.company_receipts.void','employee.claims.write','expenses.approve.manager',
    'sales.read','crm.read','inventory.read','project.read','service.read','sales.approve',
    'purchasing.approve','project.approve',
  ],
  ...
  'Finance Preparer': ['dashboard.read','finance.read','finance.write','finance.create','finance.edit','finance.post','finance.export','finance.report.export','expenses.finance.verify','expenses.payment.prepare','expenses.payment.export','expenses.company_receipts.read_company'],
  'Finance Checker': ['dashboard.read','finance.read','finance.approve','finance.pay','finance.export','expenses.approve.finance','expenses.payment.release','expenses.payment.result.import','expenses.tax_evidence.access','finance.budget.approve','expenses.company_receipts.read_company'],
...
const manifest = `${JSON.stringify({
  version: '16', businessDate: '2026-07-27', sha256: hash,
  personas: 12,
