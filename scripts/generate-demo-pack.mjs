...
const rolePermissions = {
  ...
  'Company Admin': ['dashboard.read','admin.users.invite','admin.users.read','admin.users.manage','admin.roles.read','admin.roles.write','admin.audit.read','settings.read','settings.manage','session.switch_company','hr.read','hr.write'],
  Manager: [
