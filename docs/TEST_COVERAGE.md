...
or passing tests. The current full Vitest run passes 198 files / 814 tests with 3 skipped
...
| Full unit/integration suite | Current HEAD passes 198 files with 3 skipped / 814 tests with 3 skipped; TASK-234 assistant runtime/loop regressions and TASK-235 semantic/knowledge regressions are included | PostgreSQL target and production evidence remain separate |
