...
run was billing-blocked. Current-HEAD CI run `34175591701` passed all four Vitest shards,
PostgreSQL security/concurrency, generated/static checks, the five-language desktop/mobile
matrix, smoke, full screen audit and both layout audits. GitHub Pages run `34175591694`
