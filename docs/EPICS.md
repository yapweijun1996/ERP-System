...
current-HEAD CI run `34189671568` passed all four Vitest shards, PostgreSQL security and
...
unset. Current-HEAD CI run `34189671568` passed all four Vitest shards and every required
...
- Public health/setup probes returned 502 and the exact deployed production revision is
  not proven. Current-HEAD CI run `34189671568` is green across all required gates. Source inventory is 129 Canonical
...
| TASK-199 | In Progress | Restore public availability and prove the deployed revision; local manifest publication and the bounded read-only release verifier are hardened, live origin/revision proof remains |
