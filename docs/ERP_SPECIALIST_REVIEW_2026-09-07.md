...
| `npm test` full regression | Pass on 2026-09-08 | Current HEAD passes 174 files / 714 tests with 2 skipped files and 2 skipped tests (176 files / 716 tests total). This is local unit/integration evidence; PostgreSQL target, production and remote CI remain separate. |
