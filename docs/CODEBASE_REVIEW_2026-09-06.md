...
full Vitest attempt. See [TEST_COVERAGE.md](TEST_COVERAGE.md); TASK-216 is now Done
with command-level seed/upgrade proof and TASK-217–223 remain open.
...
- The task registry currently reports **207 Done / 4 In Progress / 9 Todo / 3 Blocked / 223 Total**. TASK-216 is now complete locally; the actionable boundary is concentrated in TASK-199–205 and
