...
Current source inventory on 2026-09-07 is **129 Canonical / 0 Preview** routes. All
...
and i18n evidence remain separately recorded. The current full Vitest run passes 176 files /
724 tests with 2 skipped files and 2 skipped tests; Staff Calendar API integration remains
...
or permit tenant-side MAC mutation. TASK-206's hidden actor/session foundation,
TASK-207's source/API authorization proof and TASK-208's browser/accessibility/i18n
proof are complete; TASK-209 remains release-blocked for CI, deployment and production
evidence.
