...
and i18n evidence remain separately recorded. The current full Vitest run passes 175 files /
718 tests with 2 skipped files and 2 skipped tests; Staff Calendar API integration remains
