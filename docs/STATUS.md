...
| Canonical schema (118 tables, multi-tenant `master_fn`/`company_fn`) | ✅ Working | 40 ordered migrations through `drizzle/0039_cultured_talkback.sql`, `src/data/schema/` |
...
| Route production metadata and Preview contract | ✅ Working | `SCREEN_META` covers all 114 routes with module, Canonical/Preview maturity, data source, supported modes, active section, permission and fixture. Current baseline: **102 Canonical / 12 Preview**. Preview pages show `Preview · Sample Data` consistently and their write-like actions are disabled with an explanation. |
...
of truth for production maturity at route level: **102 routes are Canonical and 12 are
...
- Done: TASK-001…016, TASK-018…077 (76)
- Blocked: TASK-017 (1)
- Todo in the historical task registry: none. The remaining product work is the 12
