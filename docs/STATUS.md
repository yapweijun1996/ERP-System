...
| Route production metadata and Preview contract | ✅ Working | `SCREEN_META` covers all 114 routes with module, Canonical/Preview maturity, data source, supported modes, active section, permission and fixture. Current baseline: **53 Canonical / 61 Preview**. Preview pages show `Preview · Sample Data` consistently and their write-like actions are disabled with an explanation. |
...
of truth for production maturity at route level: **53 routes are Canonical and 61 are
...
`master-control`, `sys-settings` and `module-activation-control` remain Preview.
...
- Done: TASK-001…016, TASK-018…042 (41)
- Blocked: TASK-017 (1)
