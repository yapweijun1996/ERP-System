...
| Unit/API tests: domain chains, rollback, GL balance, auth security and API contracts | ✅ Working | `npm test`, 457 passing tests plus 1 expected skip and one gated PostgreSQL 16 integration proof. Coverage includes Session/CSRF/RBAC, idempotency/audit, inventory/warehouse/manufacturing/quality invariants, sales/purchasing/CRM lifecycles, finance/assets/project/service/HR/payroll postings, actor-owned governed leave, calendar scope/sync, leave-to-Payroll replay, document-provider parity and migration compatibility. |
...
boundary. TASK-118 through TASK-135 remain planning records
...
- Done: 116 tasks, including TASK-117
- Blocked: TASK-017 (1)
- Todo: 18 planned tasks (TASK-118–135) across EPIC-054–056. These extend the product
