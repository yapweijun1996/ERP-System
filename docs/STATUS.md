...
| Canonical schema (65 tables, multi-tenant `master_fn`/`company_fn`) | ✅ Working | Ordered migrations through `drizzle/0012_broad_snowbird.sql`, `src/data/schema/` |
...
| Route production metadata and Preview contract | ✅ Working | `SCREEN_META` covers all 114 routes with module, Canonical/Preview maturity, data source, supported modes, active section, permission and fixture. Current baseline: **35 Canonical / 79 Preview**. Preview pages show `Preview · Sample Data` consistently and their write-like actions are disabled with an explanation. |
...
of truth for production maturity at route level: **35 routes are Canonical and 79 are
...
**Sales enquiry and quotation routes are now Canonical (2026-07-19).** Enquiry
