...
| Route production metadata and Preview contract | ✅ Working | `SCREEN_META` covers all 114 routes with module, Canonical/Preview maturity, data source, supported modes, active section, permission and fixture. Current baseline: **54 Canonical / 60 Preview**. Preview pages show `Preview · Sample Data` consistently and their write-like actions are disabled with an explanation. |
...
of truth for production maturity at route level: **54 routes are Canonical and 60 are
...
- Done: TASK-001…016, TASK-018…043, TASK-046…048 (45)
- Blocked: TASK-017 (1)
- Todo: TASK-044, TASK-045 (frontend SSOT: appModal migration + MODULE_DEFS nav unification)
