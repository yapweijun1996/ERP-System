...
The current worktree is at migration 0087: the Drizzle journal contains **88
...
no authorization-version cache is claimed. After the purchase-requisition adapter
...
The remaining clean full-suite rerun after the Team Calendar fixture correction,
...
| Canonical schema (244 tables, multi-tenant `master_fn`/`company_fn`) | ✅ Working | 88 ordered migrations through schema version 87; `drizzle/`, `src/data/schema/` |
