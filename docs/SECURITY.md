...
disposable PostgreSQL non-superuser proof; TASK-207's adversarial authorization proof and
TASK-208's browser/accessibility/i18n proof are complete, while TASK-209 remains
release-blocked pending executable CI and deployment/production evidence. TASK-195's
