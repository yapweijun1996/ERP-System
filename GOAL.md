...
**Current evidence:** Governed document OCR/Vision exists; wizard AI selection is preview-only and no broad reporting/NL-query assistant exists. TASK-234/S1 defines the server-owned provider request/response/tool-call contract, explicit draft/waiting/running/succeeded/failed/cancelled states, whole-run deadline/cancellation, input/output/call/retry/cost limits, pre-call cost reservation and actionable fail-closed errors. TASK-234/S2 adds Company-scoped provider/model/data-policy configuration, AES-GCM credentials, explicit rotation/provider-change decisions, bounded limits, model/egress validation, permission/idempotency boundaries and secret-free views/audits. TASK-234/S3 adds the server-owned bounded Receipt conversation loop, cited facts, exact Pack preview, G06 confirmation wait/resume, governed Pack execution, persisted Pack read-back and artifact/source hash verification. TASK-234/S4 adds the contextual vanilla-JS workspace with visible sources, exact preview/confirmation, progress, cancellation, recovery, Company-scope isolation, five locale resources, both themes and desktop/375px focus/touch evidence; S5 passes the fixture, actual Demo/PGlite Pack/artifact assertions and local gates. The merged Pages candidate `a67595d5b67d24d6dfcc02b0c04f89c0e6c391ae` and latest browser-tested Pages revision `07d2b08d34b6fe9aa52bf06fb50386befc7709c8` have hosted Demo title/upload verification with no source/response/module/permission override; hosted scanning remains `scanner unavailable`. The merged CI run `34751368911` and fresh candidate run `34755628672` each terminated with `LAYOUT [desktop:user-mgmt] transaction-list-v1 root missing`; the bounded re-navigation repair in `20e8af00da0a9a4fdeee2a73b88abe2fde9bc791` then passed hosted CI run `34759696683`, including Screen, transaction-list, operational-workspace and production public-subpath gates. No real provider account or approved spend is available, so G07.3 remains explicit and TASK-234 stays in progress. See the [current hosted no-override evidence](docs/ai-native/evidence/TASK-234-2026-09-13-current-hosted-no-override.md), [merged hosted no-override evidence](docs/ai-native/evidence/TASK-234-2026-09-13-merged-hosted-no-override.md), [merged CI failure/repair evidence](docs/ai-native/evidence/TASK-234-2026-09-13-merged-ci-failure.md), [fresh CI failure evidence](docs/ai-native/evidence/TASK-234-2026-09-13-fresh-ci-failure.md), [hosted retry terminal evidence](docs/ai-native/evidence/TASK-234-2026-09-13-ci-retry-terminal.md), [prior hosted evidence](docs/ai-native/evidence/TASK-234-2026-09-13-hosted-no-override.md) and [terminal CI evidence](docs/ai-native/evidence/TASK-234-2026-09-13-ci-terminal.md) · [TASK-234/S1 evidence](docs/ai-native/evidence/TASK-234-2026-09-09.md#s1--define-runtime-states-and-limits) · [S2 evidence](docs/ai-native/evidence/TASK-234-2026-09-09.md#s2--implement-secret-safe-server-configuration) · [S3 evidence](docs/ai-native/evidence/TASK-234-2026-09-09.md#s3--build-the-receipt-conversation-loop) · [S4 evidence](docs/ai-native/evidence/TASK-234-2026-09-09.md#s4--build-the-contextual-workspace) · [S5 evidence](docs/ai-native/evidence/TASK-234-2026-09-09.md#s5--validate-fixture-and-real-model-journeys).
